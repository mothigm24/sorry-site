  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      >
        ...
        >
          <h1 className="text-3xl text-pink-300 mb-8 leading-relaxed">Dear Papa,My Sorry Letter to You…</h1>
          ...
          >
            <p className="text-purple-200 text-lg mb-8 leading-relaxed">
              I've been sitting here for hours, trying to find out for an Apology For you...
            </p>
